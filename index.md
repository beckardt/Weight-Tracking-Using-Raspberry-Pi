...
**Day 6**: To get a quick idea of what the "inside" of the scale looks like: It has 4 sensors on each corner of the scale, each sends three wires to the scales chip. As seen here:
